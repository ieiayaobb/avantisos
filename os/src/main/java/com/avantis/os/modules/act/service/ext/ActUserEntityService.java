 ...
 */
package com.avantis.os.modules.act.service.ext;

import com.avantis.os.common.utils.SpringContextHolder;
import com.avantis.os.modules.act.utils.ActUtils;
import com.avantis.os.modules.sys.entity.Role;
import com.avantis.os.modules.sys.service.SystemService;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.avantis.os.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.avantis.os.modules.sys.entity.User(null, userId)))){

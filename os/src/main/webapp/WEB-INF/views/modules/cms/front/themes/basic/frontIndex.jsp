...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var iconArr = [
			...
			{"label" : "我的面板","icon" : "static/webos/img/bd/icon-4.png","src" : "${ctxAdmin}/sys/user/info","moduleId" : "4","fenceId" : "0","fenceLabel":"测试Fence1"},
			{"label" : "请假办理","icon" : "static/webos/img/bd/icon-5.png","src" : "${ctxAdmin}/oa/leave ","moduleId" : "5","fenceId" : "0","fenceLabel":"测试Fence1"},
			{"label" : "内容发布","icon" : "static/webos/img/bd/icon-6.png","src" : "${ctxAdmin}/cms","moduleId" : "6","fenceId" : "0","fenceLabel":"测试Fence1"},
			{"label" : "评论管理","icon" : "static/webos/img/bd/icon-7.png","src" : "${ctxAdmin}/cms/comment/?status=2","moduleId" : "7","fenceId" : "0","fenceLabel":"测试Fence1"},
			{"label" : "公共留言","icon" : "static/webos/img/bd/icon-1.png","src" : "${ctxAdmin}/cms/guestbook/?status=2","moduleId" : "8","fenceId" : "abc2","fenceSequence" : 1,"fenceLabel":"测试Fence2"},
			{"label" : "文件管理","icon" : "static/webos/img/bd/icon-2.png","src" : "${ctxStatic}/ckfinder/ckfinder.html","moduleId" : "9","fenceId" : "abc3","fenceSequence" : 2,"fenceLabel":"测试Fence3"},
			{"label" : "用户管理","icon" : "static/webos/img/bd/icon-3.png","src" : "${ctxAdmin}/sys/user/","moduleId" : "10","fenceId" : "abc1","fenceSequence" : 0,"fenceLabel":"测试Fence1"},
			{"label" : "区域管理","icon" : "static/webos/img/bd/icon-4.png","src" : "${ctxAdmin}/sys/area/","moduleId" : "11","fenceId" : "abc1","fenceSequence" : 0,"fenceLabel":"测试Fence1"},
			{"label" : "机构管理","icon" : "static/webos/img/bd/icon-5.png","src" : "${ctxAdmin}/sys/office/","moduleId" : "12","fenceId" : "abc1","fenceSequence" : 0,"fenceLabel":"测试Fence1"},
